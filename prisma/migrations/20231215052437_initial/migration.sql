...
CREATE TABLE "ChatRoom" (
    ...
    CONSTRAINT "ChatRoom_pkey" PRIMARY KEY ("_id")
);
...
CREATE TABLE "ChatRoomOnUser" (
    ...
    CONSTRAINT "ChatRoomOnUser_pkey" PRIMARY KEY ("_id")
);
...
-- AddForeignKey
ALTER TABLE "ChatRoomOnUser" ADD CONSTRAINT "ChatRoomOnUser_chatRoomId_fkey" FOREIGN KEY ("chatRoomId") REFERENCES "ChatRoom"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ChatRoomOnUser" ADD CONSTRAINT "ChatRoomOnUser_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_chatRoomId_fkey" FOREIGN KEY ("chatRoomId") REFERENCES "ChatRoom"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
